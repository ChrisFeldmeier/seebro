...
// Session-stable seed injected by Go at launch time via __seebro_seed.
// Falls back to a fixed value if not set (shouldn't happen in normal operation).
// This seed is constant across all page loads within the same Seebro session,
// so hardware fingerprint values stay consistent (as they would in a real browser).
const sessionSeed = (typeof __seebro_seed !== 'undefined') ? __seebro_seed : 42;
...
// Set via __seebro_stealth_level (injected by Go). Default: 'light'.
const stealthLevel = (typeof __seebro_stealth_level !== 'undefined') ? __seebro_stealth_level : 'light';
...
// Timezone spoofing - configurable via window.__seebro_timezone
const __seebro_origGetTimezoneOffset = Date.prototype.getTimezoneOffset;
Object.defineProperty(Date.prototype, 'getTimezoneOffset', {
  value: function() { 
    return window.__seebro_timezone || __seebro_origGetTimezoneOffset.call(this);
  }
});
